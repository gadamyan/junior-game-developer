...
module.exports = exports = function(req, res, next) {
  ...
  res.render = function(view, options, fn) {
    ...
    var app = req.app
    var view_options = app.get('view options');
    if ('undefined' !== typeof view_options) {
      for (var key in view_options) {
        options[key] = view_options[key];
      }
    }
    options['SITE_URL'] = req.protocol + "://" + req.get('host');
